...
You can use this keyword to make your loop go back to the beginning. This statement is easy to misunderstand. Anyone can think that going back to the beginning implies the loop will be restarted _from_ the beginning. But, that is not the case. 
